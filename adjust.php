...
$membershipno = $_GET['adjustid'] ?? null;
...
if(isset($_POST["submit"])){
    ...
    if ($fetchPlanResult && mysqli_num_rows($fetchPlanResult) > 0) {
        ...
        $response['message'] = "Membership plan adjusted successfully.";
    } else {
        ...
        <main class="flex flex-col items-stretch w-[76%] ml-10 max-md:w-full max-md:ml-0">
            <header class="flex flex-col items-stretch mt-8 mb-10 max-md:max-w-full max-md:mt-10">
                <div class="flex w-full items-center justify-between gap-5 max-md:max-w-full max-md:flex-wrap">
                    <h1 class="text-orange-950 text-4xl font-bold my-auto">Membership Plan Adjustment</h1>
                    <!--Admin Dropdown-->
                    <div class="max-w-lg">
...
if (isset($_GET['adjustid'])) {
    $memberId = $_GET['adjustid'];
...
<!--membership plan-->
            ...
            <div class="justify-between mt-10 max-md:max-w-full">
              ...
              <h2 class="text-gray-200 text-center text-lg font-extrabold leading-6">Adjust</h2>
