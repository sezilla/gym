...
$sql = "SELECT * FROM tbl_students LIMIT $limitStart, $rowsPerPage";
  ...
  <div class="pr-12">
        ...
        <div class="flex flex-col items-center">
          ...
          <tbody id="showdata">
            ...
            <td><?php echo $row["yearsection"]; ?></td>
            <td>
...
<div class="flex justify-center mt-4 mb-4">
    <?php
    $totalRows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tbl_students"));
    $totalPages = ceil($totalRows / $rowsPerPage);

    // Previous page button
    if ($currentPage > 1) {
        echo "<a href='tbl_students.php?page=" . ($currentPage - 1) . "' class='mx-2 px-4 py-2 bg-stone-500 text-white rounded-3xl'>Previous</a>";
    }

    // Page numbers
    for ($i = 1; $i <= $totalPages; $i++) {
        echo "<a href='tbl_students.php?page=$i' class='mx-2 px-4 py-2 bg-stone-500 text-white rounded-3xl'>$i</a>";
    }

    // Next page button
    if ($currentPage < $totalPages) {
        echo "<a href='tbl_students.php?page=" . ($currentPage + 1) . "' class='mx-2 px-4 py-2 bg-stone-500 text-white rounded-3xl'>Next</a>";
    }
    ?>
</div>
<!--PAGE BUTTON END-->
